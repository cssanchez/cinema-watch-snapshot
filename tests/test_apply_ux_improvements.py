...
def test_transform_12_dynamic_filtering_a11y():
    ...
    assert 'data-front-advanced-results aria-live="polite" role="status">' in result
    assert 'data-i18n-source aria-live="polite" role="status">No screenings matched' in result
